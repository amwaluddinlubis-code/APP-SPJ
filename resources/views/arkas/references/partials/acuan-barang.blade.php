<x-ui.table min-width="1280px" pagination="server">
    ...
    <tbody>
        ...
        @empty
            <tr><td colspan="9" class="empty-cell"><p class="font-semibold text-[var(--ui-fg-strong)]">Cari acuan barang ARKAS.</p><p class="mt-1 text-base text-[var(--ui-fg-muted)]">Masukkan nama atau kata kunci barang untuk menampilkan barang dan rekening yang sesuai.</p></td></tr>
        @endforelse
    </tbody>
</x-ui.table>
