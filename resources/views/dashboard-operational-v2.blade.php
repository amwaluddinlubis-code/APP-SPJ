        ...
        <section class="overflow-hidden rounded-2xl border border-[var(--ui-line)] bg-[var(--ui-surface-base)] shadow-sm">
            <div class="border-b border-[var(--ui-line)] px-5 py-4 sm:px-6">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <span class="rounded-full border border-[var(--ui-line)] bg-[var(--ui-surface-soft)] px-3 py-1 text-xs font-semibold text-slate-600">Paling penting lebih dahulu</span>
                </div>
                    ...
                    <article @class([
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                <span @class([
                                    'inline-flex rounded-full border bg-[var(--ui-surface-base)] px-2.5 py-1 text-[11px] font-bold',
