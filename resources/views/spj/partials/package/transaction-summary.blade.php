...
<div data-package-navigation hidden class="mx-5 flex flex-wrap items-center justify-between gap-2 py-4">
    ...
    <a href="{{ route('transactions.show', $transaction->route_identifier) }}" title="Buka Detail Transaksi" class="ui-btn ui-btn-secondary inline-flex items-center gap-2 transition hover:-translate-y-0.5 hover:shadow-sm">
