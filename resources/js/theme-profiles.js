...
export const themeProfiles = Object.freeze({
    ...
    arkas_light: profile({ label: 'ARKAS Light', appearance: 'light', personality: 'operational', density: 'comfortable', radius: 'large', shadow: 'soft', header: 'gradient', sidebar: 'gradient', table: 'soft', controls: 'rounded', palette: { accent: '#22c7d6', accentStrong: '#0f5f7a', accentSoft: '#dff8fb', sidebar: '#0b4f6c', sidebarDeep: '#06344b' } }),
