...
class QuarterNumberingPlaceholderTest extends TestCase
{
    public function test_tw_placeholder_uses_document_quarter_not_month(): void
    {
        ...
        $this->assertSame('0003/OP/SDN.318/TW.I/2026', $service->renderConfiguredNumber($format, 'PESANAN', 3, Carbon::parse('2026-03-31'), 'SDN.318'));
        $this->assertSame('0004/OP/SDN.318/TW.II/2026', $service->renderConfiguredNumber($format, 'PESANAN', 4, Carbon::parse('2026-04-01'), 'SDN.318'));
        $this->assertSame('0005/OP/SDN.318/TW.III/2026', $service->renderConfiguredNumber($format, 'PESANAN', 5, Carbon::parse('2026-07-01'), 'SDN.318'));
        $this->assertSame('0006/OP/SDN.318/TW.IV/2026', $service->renderConfiguredNumber($format, 'PESANAN', 6, Carbon::parse('2026-10-01'), 'SDN.318'));
    }
