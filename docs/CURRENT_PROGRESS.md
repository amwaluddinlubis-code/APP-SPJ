...
- [x] tab Acuan Barang menampilkan relasi aktif `rapbs.kode_rekening` + `rapbs.id_barang` ke `ref_rekening` dan `ref_acuan_barang`, beserta satuan, rentang harga, klasifikasi belanja, dan jumlah pemakaian pada RKAS;
