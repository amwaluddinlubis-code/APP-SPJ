...
final class ArkasReferenceCentralSchema
{
    ...
    private const DEFINITIONS = [
        ...
        'ref_acuan_barang' => ['target_table' => 'central_ref_acuan_barang', 'natural_key' => ['id_barang'], 'version_dimensions' => ['tahun', 'arkas_release'], 'semantic_columns' => ['id_barang', 'kode_rekening', 'nama_barang', 'satuan', 'blok_id', 'kode_belanja', 'harga_barang', 'batas_bawah', 'batas_atas', 'kategori_id', 'hs_code', 'kbki', 'tahun', 'expired_date']],
        ...
        'ref_kode' => ['target_table' => 'central_ref_kode_variant', 'natural_key' => ['id_kode'], 'variant_columns' => ['parent_kode', 'uraian_kode', 'id_level_kode', 'tipe'], 'version_dimensions' => ['arkas_release'], 'semantic_columns' => ['id_kode', 'parent_kode', 'uraian_kode', 'id_level_kode', 'tipe'], 'extension_columns' => ['id_ref_kode', 'tahun', 'sumber_dana_id', 'bentuk_pendidikan_id', 'is_bos_pusat', 'is_bos_prop', 'is_bos_kab', 'is_komite', 'is_lainnnya', 'expired_date']],
    ];
