...
final class ArkasMirrorManifest
{
    ...
    private const ENTRIES = [
        ...
        'ref_kode' => [
            ...
            'school_scope_rule' => 'Semantic variant disimpan central; applicability tetap scoped oleh tenant/year/fund/education/release.',
            'variant_strategy' => 'DETERMINISTIC_SHA256_OF_CANONICAL_SEMANTIC_TUPLE',
            'applicability_dimensions' => ['tenant_id', 'tahun', 'sumber_dana_id', 'bentuk_pendidikan_id', 'arkas_release'],
