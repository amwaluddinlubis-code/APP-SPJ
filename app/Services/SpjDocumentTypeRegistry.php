    ...
    public static function all(): array
    {
        ...
        return [
            self::SPJ_COVER => [
                ...
                'required' => [
                    'NOMOR_DOKUMEN', 'NOMOR_BUKTI', 'TANGGAL_DOKUMEN', 'TAHUN_ANGGARAN',
                    'SUMBER_DANA', 'SUMBER_DANA_PERIODE', 'JENIS_SPJ', 'KODE_KEGIATAN',
                    'NAMA_KEGIATAN', 'KODE_REKENING', 'NAMA_REKENING', 'URAIAN_TRANSAKSI',
                    'NILAI_BRUTO', 'NILAI_DIBAYARKAN', 'NAMA_KEPALA_SEKOLAH',
                    'NIP_KEPALA_SEKOLAH', 'NAMA_BENDAHARA_BOSP', 'NIP_BENDAHARA_BOSP',
                ],
                'optional' => ['NAMA_PENERIMA', 'POTONGAN_PAJAK', 'TRIWULAN', 'SEMESTER'],
                'repeat_required' => [],
                'repeat_optional' => [],
                'image' => ['KOP_SURAT'],
            ],
